...
выполнение → самоподдержка знаний**. Вся инфраструктура флоу лежит в каталоге `ai-flow/`;
в корне проекта — только этот `README.md`, `CLAUDE.md`, `AGENTS.md`, `.claude/`, `.serena/`.
