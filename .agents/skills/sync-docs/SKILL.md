...
description: >
  ...
  memories the first time, or after code/behavior changes when docs or the AGENTS.md knowledge table
  have drifted.
---
...
3. Report updated `ai-flow/docs/*`, `.serena/memories/*`, and the "Project knowledge" table in `AGENTS.md`.
